...
urlpatterns = patterns('apps.calificacion.views',
    ...
    url(r'^calificaciones/(?P<id>.*)/$', 'view_calificaciones_alumno', name='vista_calificaciones_alumno'),
     url(r'^calificacion/semestre/(?P<id_semestre>.*)/(?P<id_alumno>.*)/$', 'view_calificaciones_alumno_x_semestre', name='vista_cal_alumno_x_sem'),
)
