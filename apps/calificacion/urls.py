...
urlpatterns = patterns('apps.calificacion.views',
    ...
    url(r'^lista_semestres/(?P<id>.*)/$', 'view_calificaciones_alumno', name='vista_calificaciones_alumno'),
     url(r'^calificacion/semestre/(?P<id_semestre>.*)/(?P<id_user>.*)/$', 'view_calificaciones_alumno_x_semestre', name='vista_cal_alumno_x_sem'),
     url(r'^calificacion_semestre/(?P<id_semestre>.*)/(?P<id_user>.*)/pdf/$', 'pdf_calificaciones_alumno_x_semestre', name='pdf_cal_alumno_x_sem'),
